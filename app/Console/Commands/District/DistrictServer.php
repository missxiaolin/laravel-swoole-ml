...
use App\Core\Swoole\Handler\Test3Handler;
use App\Support\Train;
use Exception;
use swoole_server;

class DistrictServer extends RpcServer
{
    /**
     ...
     * @var string
     */
    protected $signature = 'district:swoole:server';
    ...
    {
        $this->setHandler('test',Test3Handler::getInstance());
        parent::__construct();
    }
